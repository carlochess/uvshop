...
abstract class Compra implements ActiveRecordInterface
{
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CompraTableMap::translateFieldName('IdFactura', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_factura = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CompraTableMap::translateFieldName('CantProd', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cant_prod = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : CompraTableMap::translateFieldName('Valor', TableMap::TYPE_PHPNAME, $indexType)];
            $this->valor = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : CompraTableMap::translateFieldName('Iva', TableMap::TYPE_PHPNAME, $indexType)];
            $this->iva = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : CompraTableMap::translateFieldName('PorcetajeRed', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 6; // 6 = CompraTableMap::NUM_HYDRATE_COLUMNS.
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[1] => $this->getIdFactura(),
            $keys[2] => $this->getCantProd(),
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setIdFactura($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setCantProd($arr[$keys[2]]);
