...
class CompraTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdProd', 'IdFactura', 'CantProd', 'Valor', 'Iva', 'PorcetajeRed', ),
        self::TYPE_STUDLYPHPNAME => array('idProd', 'idFactura', 'cantProd', 'valor', 'iva', 'porcetajeRed', ),
        self::TYPE_COLNAME       => array(CompraTableMap::ID_PROD, CompraTableMap::ID_FACTURA, CompraTableMap::CANT_PROD, CompraTableMap::VALOR, CompraTableMap::IVA, CompraTableMap::PORCETAJE_RED, ),
        self::TYPE_RAW_COLNAME   => array('ID_PROD', 'ID_FACTURA', 'CANT_PROD', 'VALOR', 'IVA', 'PORCETAJE_RED', ),
        self::TYPE_FIELDNAME     => array('id_prod', 'id_factura', 'cant_prod', 'valor', 'iva', 'porcetaje_red', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdProd' => 0, 'IdFactura' => 1, 'CantProd' => 2, 'Valor' => 3, 'Iva' => 4, 'PorcetajeRed' => 5, ),
        self::TYPE_STUDLYPHPNAME => array('idProd' => 0, 'idFactura' => 1, 'cantProd' => 2, 'valor' => 3, 'iva' => 4, 'porcetajeRed' => 5, ),
        self::TYPE_COLNAME       => array(CompraTableMap::ID_PROD => 0, CompraTableMap::ID_FACTURA => 1, CompraTableMap::CANT_PROD => 2, CompraTableMap::VALOR => 3, CompraTableMap::IVA => 4, CompraTableMap::PORCETAJE_RED => 5, ),
        self::TYPE_RAW_COLNAME   => array('ID_PROD' => 0, 'ID_FACTURA' => 1, 'CANT_PROD' => 2, 'VALOR' => 3, 'IVA' => 4, 'PORCETAJE_RED' => 5, ),
        self::TYPE_FIELDNAME     => array('id_prod' => 0, 'id_factura' => 1, 'cant_prod' => 2, 'valor' => 3, 'iva' => 4, 'porcetaje_red' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
