...
<div class="container-fluid">
                        ...
                        foreach ($detallesProductos as $producto) { ?>
                            <div class="item" >
                                ...
                                <div class="row">
                                    ...
                                    <input type="hidden" id="id" name="<?php echo $i;
                            $i++; ?>" value="<?php echo $producto->id_prod; ?>">
                                    <div class="col-xs-8"> 
    ...
    <?php } ?>
                                            <tr>
                                                <td> cantidad </td>
                                                <td><input type="text" class="cantidad" name="<?php echo $i;
    $i++; ?>" value="<?php echo $cantidadInit[($producto->id_prod)]; ?>" /> </td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
